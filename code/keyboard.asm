...
; --- read_numkeys
;
; Reads the numeric keys. 
;===========================================================
;read_numkeys:
;	
;	in	a,(0xaa)	; get current byte
;	and	0xf0		; preserve high 4 bits
;	or	9		; set row (9) to retrieve
;	ld	c,a
;	out	(0xaa),a	
;	in	a,(0xa9)	; get value
;	ld	b,a
...
; --- translate_key
;
; Translates the key from a jap keyboard to an international key.
; should be possible to add more keyboard layouts.
;
; This function is used for tone editing and function control 
;===========================================================
;translate_key:
;
;	;--- Only process if there is a key pressed
;	and	a
;	ret	z
;	
;	;--- get the keyboard type
;	push	af
;_keyboardtype:		; self modfying code here!!
;	ld	a,0
;	and	7
;	jr.	z,_tk_jap
;	
