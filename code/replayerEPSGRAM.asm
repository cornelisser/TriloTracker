...
AY_regEnvB 		db	1	; Volume Env Freq low (8bit)	
			db	0	; Volume Env Freq high (4bit)
AY_regEnvC 		db	1	; Volume Env Freq low (8bit)	
		 	db	0	; Volume Env Freq high (4bit)
AY_regEnvShapeB	db	0
AY_regEnvShapeC	db	0
AY_regDutyA		db	0
AY_regDutyB		db	0
AY_regDutyC		db	0
...
SCC_regNOISE 	db	0	; Noise freq (5bit)
SCC_regMIXER 	db	0	; x3f	; Mixer control (1 = off, 0 = on)					; Tone E freq high
SCC_regVOLA 	db	0	; Chan A volume
SCC_regVOLB 	db	0	; Chan B volume
SCC_regVOLC  	db	0	; Chan C volume
SCC_regEnvA		db	1	; Volume Env Freq low (8bit)	
 			db	0	; Volume Env Freq high (4bit)
SCC_regEnvShapeA 	db	0	; Volume Env Shape (4bit)
SCC_regEnvB 	db	1	; Volume Env Freq low (8bit)	
			db	0	; Volume Env Freq high (4bit)
SCC_regEnvC 	db	1	; Volume Env Freq low (8bit)	
		 	db	0	; Volume Env Freq high (4bit)
SCC_regEnvShapeB	db	0
SCC_regEnvShapeC	db	0
SCC_regDutyA	db	0
SCC_regDutyB	db	0
SCC_regDutyC	db	0
