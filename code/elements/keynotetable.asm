...
_KEY_NOTE_TABLE_START:
	db	  2+25+1,   255+0,  1+12+1,  3+12+1,   255+0,  6+12+1,  8+12+1, 10+12+1		; 0-7
	db	   255+0,  1+24+1,   255+0,  8+24+1,   255+0,  5+24+1,  7+24+1,  3+12+1		; 8-15
	db   	   255+0,   255+0,  0+12+1,  2+12+1,  4+12+1,   255+0,    96+1,     7+1 	; 16-23
	db	     4+1,     3+1,  4+12+1,   255+0,     6+1,     8+1,  0+24+1,    10+1		; 24-31
	db	       0,  1+12+1,    11+1,     9+1,  2+24+1,  4+24+1,  0+12+1,  5+12+1		; 32-39
	db	     1+1,  7+12+1, 11+12+1,     5+1,  2+12+1,     2+1,  9+12+1,     0+1		; 40-47
;	db	255	; 0x21  !
;	db	255 	; 0x22	" 	  
;	db	1+3+12+12	; 0x23	# 	  
;	db	255	; 0x24  $
